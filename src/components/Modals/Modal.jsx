  ...
  return (
    <div className="modal">
      <div className="content">
        ...
        {!loading ?
          <div className="body" >
            <h3 className="title">Personal Information
            ...
            <div className="form">
              <div className="form-group">
                <div className="form-item">
                  <input onChange={(e) => setReservation(e.currentTarget.value)} value={reservation} required type="text" name="name" id="name" placeholder="Name" />
                  <label htmlFor="name">
                ...
                <div className="form-item">
                  <input required type="email" name="mail" id="mail" placeholder="Email Adress" />
                  <label htmlFor="mail">
              ...
              <div className="form-group">
                <div className="form-item">
                  <input required type="date" name="date" id="date" placeholder="Select Date" />
                </div>
                <div className="form-item">
